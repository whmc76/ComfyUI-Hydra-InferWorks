...
def _ensure_runtime() -> None:
    ...
    if not source.is_file():
        raise RuntimeError(
            ...
            "Reinstall ComfyUI Top TTS from its official GitHub repository."
        )
...
class TopTTS25Synthesize:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "model": (MODEL_TYPE,),
                "text": ("STRING", {"multiline": True, "default": "你好，欢迎使用 ComfyUI Top TTS。"}),
...
class TopTTS25UnloadModel:
    @classmethod
    def INPUT_TYPES(cls):
        return {"required": {"model": (MODEL_TYPE,)}}
    ...
    def unload(self, model: TopTTSModel):
        model.unload()
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "TopTTS25ModelLoader": "Top TTS 2.5 - Load Model",
    "TopTTS25EmotionVector": "Top TTS 2.5 - Emotion Vector",
    "TopTTS25Synthesize": "Top TTS 2.5 - Synthesize",
    "TopTTS25UnloadModel": "Top TTS 2.5 - Unload Model",
}
