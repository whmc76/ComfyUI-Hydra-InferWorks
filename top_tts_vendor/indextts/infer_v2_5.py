...
from top_tts_vendor.indextts.utils.nemo_tn import normalize_text as nemo_text_normalize

from top_tts_vendor.indextts.s2mel.modules.commons import load_checkpoint2, MyModel
from top_tts_vendor.indextts.s2mel.modules.bigvgan import bigvgan
from top_tts_vendor.indextts.s2mel.modules.campplus.DTDNN import CAMPPlus
from top_tts_vendor.indextts.s2mel.modules.audio import mel_spectrogram
...
class IndexTTS2:
    def __init__(
        ...
        if self.use_cuda_kernel:
            ...
            try:
                from top_tts_vendor.indextts.s2mel.modules.bigvgan.alias_free_activation.cuda import activation1d
