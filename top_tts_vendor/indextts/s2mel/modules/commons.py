...
class MyModel(nn.Module):
    def __init__(self,args, use_emovec=False, use_gpt_latent=False):
        ...
        from top_tts_vendor.indextts.s2mel.modules.flow_matching import CFM
        from top_tts_vendor.indextts.s2mel.modules.length_regulator import InterpolateRegulator
