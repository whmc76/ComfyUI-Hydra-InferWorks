...
def _download_model_resources(source, model_dir):
    if source == "auto":
        from top_tts_vendor.indextts.utils.model_download import snapshot_download
        snapshot_download(MODEL_REPO_ID, local_dir=str(model_dir))
    elif source == "modelscope":
        from top_tts_vendor.indextts.utils.model_download import _snapshot_from_modelscope
...
def _load_indextts2(model_dir=None):
    ...
    from top_tts_vendor.indextts.infer_v2 import IndexTTS2
