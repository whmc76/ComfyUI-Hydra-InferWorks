...
not covered by this repository's Apache-2.0 license. Upstream modifications made for this plugin
are namespace-only integration changes and are not endorsed, warranted, or guaranteed by the
original right-holder. The original right-holder disclaims all liability related to these changes.
